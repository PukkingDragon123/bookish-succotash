...
export const BEASTS = {
  ...
  bison: {
    ...
    cfg: {
      ...
      tail: { style: 'stub', len: 6, thick: 1.1 },
  ...
  bear: {
    ...
    cfg: {
      ...
      neck: { len: 1.4, thick: 4.4 },
      head: { r: 4.2, muzzle: 3.2, muzzleH: 2.6, snout: 'blunt', jaw: 0.2 },
      ears: { style: 'round', size: 2, spread: 3 },
      legs: { len: 4.6, thick: 2.3, spread: 4.8, foot: 'paw', digitigrade: false },
      tail: { style: 'stub', len: 3, thick: 1.2 },
  ...
  raven: {
    ...
    cfg: {
      scale: 0.86,
      body: { len: 5.6, hgt: 3.6, chest: 1, haunch: 0.9 },
      neck: { len: 1.4, thick: 2.2 },
      head: { r: 2.5, muzzle: 3, muzzleH: 1.6, snout: 'beak' },
      ears: { style: 'none', size: 0, spread: 0 },
      legs: { len: 3, thick: 0.8, spread: 1.8, count: 2, foot: 'paw', digitigrade: false },
  ...
  magpie: {
    ...
    cfg: {
      scale: 0.74,
      body: { len: 4.8, hgt: 3, chest: 0.95, haunch: 0.9 },
      neck: { len: 1.2, thick: 1.9 },
      head: { r: 2.2, muzzle: 2.2, muzzleH: 1.3, snout: 'beak' },
      ears: { style: 'none', size: 0, spread: 0 },
      legs: { len: 2.6, thick: 0.7, spread: 1.6, count: 2, foot: 'paw', digitigrade: false },
  ...
  eagle: {
    ...
    cfg: {
      scale: 1,
      body: { len: 6.4, hgt: 4.2, chest: 1.1, haunch: 0.9 },
      neck: { len: 1.4, thick: 2.6 },
      head: { r: 2.7, muzzle: 3, muzzleH: 1.8, snout: 'beak' },
      ears: { style: 'none', size: 0, spread: 0 },
      legs: { len: 3, thick: 1, spread: 2, count: 2, foot: 'paw', digitigrade: false },
  ...
  crane: {
    ...
    cfg: {
      scale: 1.02,
      body: { len: 5.8, hgt: 4, chest: 1, haunch: 0.9 },
      neck: { len: 7.5, thick: 1.7 },
      head: { r: 2.1, muzzle: 3.4, muzzleH: 1.2, snout: 'beak' },
      ears: { style: 'none', size: 0, spread: 0 },
      legs: { len: 9, thick: 0.8, spread: 2, count: 2, foot: 'paw', digitigrade: false },
